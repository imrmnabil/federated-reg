...
def server_fn(context: Context):
    ...
    global_test_set = load_dataset("naabiil/power_consumption")["test"]
    ...
    x_test = global_test_set.to_pandas()[features].values
    y_test = global_test_set.to_pandas()[target].values
